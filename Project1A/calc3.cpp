...
// This program is the improved version of Calc 2. 
...
// In addition it can square numbers
// requires linux command "./calc3 < formulas.txt"
...
int main() {
    ...
    while (cin >> input) {                                                                                                             
        if (input == '+') { 
            ...
            add ? (total += (nextNum * nextNum)) : (total -= (nextNum * nextNum));
            nextNum = 0;
